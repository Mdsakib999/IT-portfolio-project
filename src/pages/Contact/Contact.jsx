							...
							<div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-purple-100 p-4 sm:p-6 lg:p-8">
								...
								<div className="space-y-4 sm:space-y-6">
									...
									<div className="relative group">
										<div className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-gray-400 group-focus-within:text-[#5E35B1] transition-colors duration-300">
										...
										<input
											...
											className={`w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-4 border-2 rounded-xl sm:rounded-2xl transition-all duration-300 text-sm sm:text-base placeholder:text-xs sm:placeholder:text-sm focus:outline-none focus:ring-4 focus:ring-[#5E35B1]/20 ${
												errors.name
													? "border-red-300 focus:border-red-500"
													: "border-gray-200 focus:border-[#5E35B1] hover:border-gray-300"
											}`}
										/>
										{errors.name && (
									...
									{/* Message Field */}
									<div className="relative group">
										<div className="absolute left-3 sm:left-4 top-4 sm:top-5 text-gray-400 group-focus-within:text-[#5E35B1] transition-colors duration-300">
										...
										<textarea
											...
											className={`w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-4 border-2 rounded-xl sm:rounded-2xl transition-all duration-300 text-sm sm:text-base placeholder:text-xs sm:placeholder:text-sm focus:outline-none focus:ring-4 focus:ring-[#5E35B1]/20 resize-none ${
												errors.message
													? "border-red-300 focus:border-red-500"
													: "border-gray-200 focus:border-[#5E35B1] hover:border-gray-300"
											}`}
