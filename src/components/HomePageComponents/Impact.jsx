			...
			<div className="grid grid-cols-2 md:grid-cols-4 gap-10 mt-12 lg:px-16">
				<div className="flex flex-col items-center min-w-[120px]">
					...
					<div className="text-center mt-5">
						<p className="font-bold text-lg font-sans mb-2">1000+</p>
				...
				<div className="flex flex-col items-center min-w-[120px]">
					...
					<div className="text-center mt-5">
						<p className="font-bold text-lg font-sans mb-2">100+</p>
				...
				<div className="flex flex-col items-center min-w-[120px]">
					...
					<div className="text-center mt-5">
						<p className="font-bold text-lg font-sans mb-2">99%</p>
				...
				<div className="flex flex-col items-center min-w-[120px]">
					...
					<div className="text-center mt-5">
						<p className="font-bold text-lg font-sans mb-2">10+</p>
