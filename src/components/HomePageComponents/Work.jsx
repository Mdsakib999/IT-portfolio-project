...
const Work = () => {
	return (
		<div className="relative py-10 px-4 my-10 overflow-hidden mt-20">
			{/* Blobs */}
			...
			{/* Process Tags */}
			<ul className="mt-20 w-full max-w-[90%] md:max-w-[80%] mx-auto border rounded-full flex flex-wrap items-center justify-between gap-4 px-8 py-3 bg-[#5E35B1] text-white hover:bg-purple-700 duration-300 text-base">
			...
			{/* Icons */}
			<div className="flex flex-wrap items-center justify-center gap-8 w-full max-w-[90%] md:max-w-[80%] mx-auto px-2 text-center mt-12">
