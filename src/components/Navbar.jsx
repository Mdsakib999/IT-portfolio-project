...
const Navbar = () => {
  ...
  return (
    <div className="fixed left-1/2 transform -translate-x-1/2 z-50 bg-white shadow max-w-7xl px-2 sm:px-4 lg:px-8 rounded-b-2xl min-w-[280px] font-serif w-full">
